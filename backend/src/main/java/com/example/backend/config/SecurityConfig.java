...
import com.example.backend.handle.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    @Value("${app.cors.allowed-origins:http://localhost:3000,https://recommendation.site}")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // ⚠️ ห้ามใช้ "*" เด็ดขาดเมื่อ allowCredentials = true (เบราว์เซอร์จะบล็อก)
