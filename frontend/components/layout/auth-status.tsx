    ...
    <>
      <div className={nocturne.sidebarFooterRow}>
        <Link
          ...
          aria-label={isCollapsed ? "เข้าสู่ระบบ" : undefined}
        >
          ...
          <span className={nocturne.sidebarAuthLabel}>เข้าสู่ระบบ</span>
        </Link>
        <Link
          href="/register"
          onClick={onNavigate}
          ...
          aria-label={isCollapsed ? "สมัครสมาชิก" : undefined}
        >
          <svg width="16" height="16" viewBox="0 0 256 256" fill="currentColor" aria-hidden="true" className={nocturne.sidebarAuthIcon}>
          ...
          <span className={nocturne.sidebarAuthLabel}>สมัครสมาชิก</span>
        </Link>
      </div>
      <Link href="/login" onClick={onNavigate} className={nocturne.sidebarGoogleBtn} title={isCollapsed ? "เข้าสู่ระบบด้วย Google" : undefined}>
