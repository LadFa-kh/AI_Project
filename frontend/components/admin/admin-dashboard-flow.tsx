...
// split-word heading) — identical pattern to internship-matches-flow.tsx /
// upload-resume-flow.tsx / skill-assessment-flow.tsx. All dashboard content
// (stat cards, chart, activity feed, user table) lives in
// AdminDashboardView; this file only owns the surrounding page shell.

import { useEffect, useMemo, useRef } from "react";
import { AdminDashboardView } from "./admin-dashboard-view";
import styles from "./admin-dashboard.module.css";

const HEADING = "แดชบอร์ดผู้ดูแลระบบ";
