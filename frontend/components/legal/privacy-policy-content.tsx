// Privacy policy body — shared by /privacy-policy and the in-form LegalDialog
// (register form + consent modal), so the text lives in exactly one place.
// Source: docs/PRIVACY_POLICY_TH.md (approved v1.0).

import Link from "next/link";
import styles from "./privacy-policy.module.css";

export const PRIVACY_POLICY_VERSION = "1.0";
export const PRIVACY_POLICY_EFFECTIVE_DATE_LABEL = "24 กันยายน 2569";
/** Confirmed by backend (FRONTEND_REQUESTS รอบ 4 ข้อ 3.5) — ผู้ตรวจอนุมัติ: นายรัชพล ศรีชำนาญ. null = generic wording. */
export const CONTACT_EMAIL: string | null = "ratchaponsrichamnan@gmail.com";
