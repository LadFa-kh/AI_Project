...
11) ก่อนสรุปหรือแก้ไขไฟล์ใด ๆ ต้องอ่าน/stage เนื้อหาไฟล์จริงจากเครื่องก่อนเสมอ ห้ามสมมติ content จากบทสนทนาก่อนหน้าหรือความจำ — โดยเฉพาะไฟล์ CSS/type ที่ถูกแก้บ่อย เพราะเคยเกิดปัญหาไฟล์ถูกเขียนทับบางส่วน (truncate) และ type mismatch จากการไม่เช็คไฟล์จริงมาแล้ว
